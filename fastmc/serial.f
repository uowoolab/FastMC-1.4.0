...
c***********************************************************************
      ...
      subroutine gisum3(aaa,iii,nnn,bbb)
...
c***********************************************************************
      ...
      subroutine gdsum3(aaa,iii,mmm,nnn,bbb)

c***********************************************************************
c
c     dummy dsum for serial DL_POLY
c
c***********************************************************************
...
c*********************************************************************
      ...
      logical lshmov
      integer idnode,mxnode,natms,nscons,ierr,i,j,k
